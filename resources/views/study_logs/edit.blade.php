<x-layouts::app :title="'勉強記録編集'">
    ...
    <div class="p-6">
        ...
        <form action="{{ route('study-logs.update', $studyLog->id) }}" method="POST">
                ...
                <select name="cafe_id" class="border p-2 w-full">
                    ...
                    @foreach ($cafes as $cafe)
                        ...
                        <option value="{{ $cafe->id }}"
                            {{ $studyLog->cafe_id == $cafe->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select name="satisfaction" class="border p-2 w-full">
                    ...
                    @for ($i = 1; $i <= 5; $i++)
                        ...
                        <option value="{{ $i }}"
                            {{ $studyLog->satisfaction == $i ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="visited_at"
                    name="visited_at"
                    value="{{ old('visited_at', $studyLog->visited_at->format('Y-m-d')) }}"
            ...
            <div class="mb-4">
                ...
                <textarea
                    name="memo"
                    rows="4"
                    class="border p-2 w-full">{{ $studyLog->memo }}</textarea>
